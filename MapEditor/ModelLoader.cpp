...
void ModelLoader::loadGround(const tinyxml2::XMLElement& groundElem)
{
...
void ModelLoader::loadPlatform(const tinyxml2::XMLElement& platformElem)
{
    ...
    Platform& platform = Model::instance().createPlatform();
